        ...
        app.Configure(config =>
        {
            ...
            config.AddBranch("instance",
                             instance =>
                             {
                                 ...
                                 instance
                                    .AddCommand<InstanceInstallCommand>("install")
                                    .WithDescription("Install a modpack from a repository by PREF.");
                                 instance
            ...
            config.AddCommand<InstanceInstallCommand>("install").WithDescription("Shortcut for instance install.");
