    ...
    )
    {
        ...
        services.AddLogging(logging =>
        {
            ...
            logging.SetMinimumLevel(
                isDebug || cliContext.Debug ? LogLevel.Debug
                : cliContext.Verbose ? LogLevel.Information
                : LogLevel.Warning
            );
        });
        ...
        app.Configure(config =>
        {
            ...
            config.AddBranch(
                ...
                instance =>
                {
                    ...
                    instance
                        ...
                        .WithDescription("Create an instance.");
                    instance
                        .AddCommand<InstanceListCommand>("list")
                        .WithDescription("List instances.");
                    instance
                    ...
                    instance
                        .AddCommand<InstanceRunCommand>("run")
                        .WithDescription("Run an instance.");
                }
            );

            config
                .AddCommand<CreateCommand>("create")
                .WithDescription("Shortcut for instance create.");
            config
                .AddCommand<InstanceImportCommand>("import")
                .WithDescription("Shortcut for instance import.");
            config
                .AddCommand<InstanceExportCommand>("export")
                .WithDescription("Shortcut for instance export.");
            config
                .AddCommand<InstanceBuildCommand>("build")
                .WithDescription("Shortcut for instance build.");
            config
                .AddCommand<InstanceRunCommand>("run")
                .WithDescription("Shortcut for instance run.");
            config
                .AddCommand<InstanceListCommand>("list")
                .WithDescription("Shortcut for instance list.");
            config
                .AddCommand<InstanceInspectCommand>("inspect")
            ...
            config.AddBranch(
                ...
                loader =>
                {
                    ...
                    loader
                        .AddCommand<LoaderHelpCommand>("help")
                        .WithDescription("Show loader help.");
                    loader
                        .AddCommand<LoaderListCommand>("list")
                        .WithDescription("List supported loaders.");
                    loader
                        .AddCommand<LoaderGetCommand>("get")
                        .WithDescription("Get instance loader.");
                    loader
                        .AddCommand<LoaderSetCommand>("set")
                        .WithDescription("Set instance loader.");
                    loader.AddBranch(
                        "version",
                        version =>
                        {
            ...
            config.AddBranch(
                ...
                package =>
                {
                    ...
                    package
                        .AddCommand<PackageSearchCommand>("search")
                        .WithDescription("Search packages.");
                    package
                    ...
                    package.AddBranch(
                        ...
                        dependent =>
                        {
                            dependent.SetDescription(
                                "Inspect instance-local reverse dependencies."
                            );
                            dependent
            ...
            config
                .AddCommand<PackageSearchCommand>("search")
                .WithDescription("Shortcut for package search.");
            config
                .AddCommand<PackageAddCommand>("add")
            ...
            config.AddBranch(
                ...
                configCommand =>
                {
                    configCommand.SetDescription(
                        "Manage CLI global config and instance overrides."
                    );
                    configCommand
            ...
            config.AddBranch(
                ...
                account =>
                {
                    ...
                    account
                        .AddCommand<AccountHelpCommand>("help")
                        .WithDescription("Show account help.");
                    account
                        .AddCommand<AccountListCommand>("list")
