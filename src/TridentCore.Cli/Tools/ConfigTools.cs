    ...
    ProfileManager profileManager)
{
    ...
    public string Get(
        ...
        JsonSerializer.Serialize(ConfigOperation.Get(resolver, configuration, name, instance, profile),
                                 McpJson.Options);
    ...
    public string Set(
        ...
        [Description("Instance key (optional)")] string? instance = null,
        [Description("Profile file path (optional)")] string? profile = null) =>
        JsonSerializer.Serialize(ConfigOperation.Set(resolver,
                                                     configuration,
                                                     profileManager,
                                                     name,
                                                     value,
    ...
    [McpServerTool(Name = "config_unset")]
    ...
    [McpServerTool(Name = "config_list")]
