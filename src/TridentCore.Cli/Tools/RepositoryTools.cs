...
{
    [McpServerTool(Name = "repository_list"), Description("List all configured repositories.")]
    public string List()
        => JsonSerializer.Serialize(RepositoryOperation.List(userRepositories, combined), McpJson.Options);

    [McpServerTool(Name = "repository_status"), Description("Check repository status and capabilities.")]
    ...
    [McpServerTool(Name = "repository_add"), Description("Add or replace a user-configured repository.")]
    public string Add(
    ...
    [McpServerTool(Name = "repository_remove"), Description("Remove a user-configured repository.")]
