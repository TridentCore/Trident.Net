...
{
    [McpServerTool(Name = "trident_package_list"), Description("List packages installed in a Trident instance.")]
    ...
    [McpServerTool(Name = "trident_package_search"), Description("Search for packages in remote repositories or within an instance.")]
    ...
    [McpServerTool(Name = "trident_package_add"), Description("Add a package to a Trident instance by PURL.")]
    public string Add(
    ...
    [McpServerTool(Name = "trident_package_inspect"), Description("Inspect a package by PURL, optionally in the context of an instance.")]
    ...
    [McpServerTool(Name = "trident_package_set_enabled"), Description("Enable or disable an installed package in an instance.")]
    ...
    [McpServerTool(Name = "trident_package_dependency_list"), Description("List dependencies of a package version.")]
    ...
    [McpServerTool(Name = "trident_package_dependent_list"), Description("List packages in an instance that depend on a given package.")]
    ...
    [McpServerTool(Name = "trident_package_version_list"), Description("List available versions of a package.")]
    ...
    [McpServerTool(Name = "trident_package_version_set"), Description("Set the version of an installed package.")]
