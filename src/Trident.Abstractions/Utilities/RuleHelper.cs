...
public static class RuleHelper
{
    ...
    public static bool Evaluate(Input input, Profile.Rice.Rule.RuleSelector selector) =>
        selector.Type switch
        {
            ...
            Profile.Rice.Rule.RuleSelector.SelectorType.Not => selector.Children?.All(x => !Evaluate(input, x)) ?? false,
            ...
            Profile.Rice.Rule.RuleSelector.SelectorType.Tag => selector.Tag != null && input.Entry.Tags.Contains(selector.Tag),
            Profile.Rice.Rule.RuleSelector.SelectorType.Kind => selector.Kind != null && selector.Kind == input.Package.Kind,
            _ => false
        };
