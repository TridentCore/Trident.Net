...
using Trident.Cli.Commands.Account;
using Trident.Cli.Commands.Instance;
using Trident.Cli.Commands.Loader;
using Trident.Cli.Commands.Package;
using Trident.Cli.Commands.Package.Dependency;
using Trident.Cli.Commands.Package.Dependent;
using Trident.Cli.Commands.Package.Version;
using Trident.Cli.Commands.Repository;
        ...
        app.Configure(config =>
        {
            ...
            config.AddBranch(
                ...
                instance =>
                {
                    ...
                    instance.AddCommand<InstanceBuildCommand>("build").WithDescription("Build an instance.");
                    instance
            ...
            config
                .AddCommand<InstanceInspectCommand>("inspect")
                .WithDescription("Shortcut for instance inspect.");
            ...
            config.AddBranch(
                ...
                loader =>
                {
                    ...
                    loader.AddCommand<LoaderListCommand>("list").WithDescription("List supported loaders.");
            ...
            config.AddBranch(
                ...
                package =>
                {
                    ...
                    package.AddCommand<PackageListCommand>("list").WithDescription("List installed packages.");
                    package.AddCommand<PackageSearchCommand>("search").WithDescription("Search packages.");
                    package.AddCommand<PackageAddCommand>("add").WithDescription("Add packages to an instance.");
                    package.AddCommand<PackageInspectCommand>("inspect").WithDescription("Inspect a package.");
                    package.AddCommand<PackageEnableCommand>("enable").WithDescription("Enable an installed package.");
                    package.AddCommand<PackageDisableCommand>("disable").WithDescription("Disable an installed package.");
                    package.AddBranch(
                        "dependency",
                        dependency =>
                        {
                    ...
                    package.AddBranch(
                        ...
                        dependent =>
                        {
                            dependent.SetDescription("Inspect instance-local reverse dependencies.");
                            dependent
            ...
            config.AddBranch(
                ...
                repository =>
                {
                    ...
                    repository.AddCommand<RepositoryHelpCommand>("help").WithDescription("Show repository help.");
                    repository.AddCommand<RepositoryListCommand>("list").WithDescription("List repositories.");
                    repository.AddCommand<RepositoryStatusCommand>("status").WithDescription("Check repository status.");
                    repository.AddCommand<RepositoryAddCommand>("add").WithDescription("Add or replace a user repository.");
                    repository.AddCommand<RepositoryRemoveCommand>("remove").WithDescription("Remove a user repository.");
                }
            );
            ...
            config.AddBranch(
                ...
                account =>
                {
                    ...
                    account.AddCommand<AccountRemoveCommand>("remove").WithDescription("Remove an account.");
                }
            );
        });
}
