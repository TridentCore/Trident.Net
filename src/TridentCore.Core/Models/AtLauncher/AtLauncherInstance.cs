...
public record AtLauncherInstance(
    string? Id,
    AtLauncherInstance.LauncherData? Launcher)
{
    public record LauncherData(string? Name, AtLauncherInstance.LoaderVersion? LoaderVersion);
